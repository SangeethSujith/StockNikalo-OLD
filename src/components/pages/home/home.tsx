                          ...
                          <div className="card-body">
                            <div className="row">
                              <div className="col-md-6">
                                ...
                                <p>
                                  We've known how to handle materials for over
                                  70 years, and our full line of material
                                  handling products, includes the best of the
                                  best in trucks and carts, dock equipment,
                                  dollies, hoists, cranes, drum barrels, and
                                  more
                                </p>
                            ...
                            <div className="product-details">
                              ...
                              <h3 className="product-title">
                                ...
                                <a href="# ">
                                  ...
                                  Core/Solid Wire MAG Welding Machine with 1
                                  Year Warranty
                                </a>{" "}
                              </h3>
                              {/* End .product-container */}
