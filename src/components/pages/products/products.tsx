                      ...
                      <div className="product-default">
                        <figure>
                          ...
                          <a href={`/product?id=${item.productId}`}>
                            {" "}
                            <img
                              src={(item?.images != undefined)?item?.images[0]?.image:''}
                              width={280}
                              height={280}
                              alt="product"
                            />{" "}
                        ...
                        <div className="product-details">
                          ...
                          <div className="product-action">
                            ...
                            <a className="btn-quickview" onClick={(e)=> handleClick(item.productId,item.salePrice)}  title="Quick View">
          ...
          {/* End .row */}
                ...
                {Array.isArray(itemData) && itemData.length > 0 &&
                  ...
                  <div
                    ...
                    style={{ boxShadow: "0 0 8px rgba(0, 0, 0, 0.6)" }} hidden={itemPopup}
                  >
                    ...
                    <div className="row pt-4">
                      <div className="col-sm-8">
                        ...
                        <ul className="nav nav-tabs" role="tablist">
                          <div className="container w-100">
                            <div className="row">
                              {
                                itemData[0]?.images?.filter((item:any, index:number) => index < 4).map((item: any) => (
                      ...
                      <div className="col-sm-4">
                        <div className="col-lg-7 col-md-6 product-single-details">
                          <h4 className="product-title">{itemData[0]?.productName}</h4>
                          ...
                          <div className="price-box">
                            <span className="old-price">₹{itemData[0]?.mrp}</span>
                            <span className="new-price">₹{itemData[0]?.salePrice}</span>
                          </div>
                          {/* End .price-box */}
                          ...
                          <div className="product-action">
                            ...
                            <div className="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                              ...
                              <input id="cartqty" value={1} className="horizontal-quantity form-control" type="text" />
